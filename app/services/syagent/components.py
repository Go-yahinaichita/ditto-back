        ...
        self.prompt = ChatPromptTemplate(
            [
                (
                    "system",
                    """
                あなたはユーザーの{time_frame}年後の未来のプロフィールを作成するアシスタントです。
                現在のプロフィールに基づいて、ツールを用いて必要な情報を集めてください。
                これまでに集めた情報を確認し、十分な情報が集まった場合はツールの呼び出さずに、「情報収集完了」のみ出力してください。        
                """,
                ),
                (
                    "human",
